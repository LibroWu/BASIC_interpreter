 ...
 * run the program
 */
    void run_program(EvalState& state);
/*
 * Method: show_help
 * Usage: program.show_help();
 * or:    Program::show_help();
 * ------------------------------------------------------------
 * show the help list
 */
...
/*
 * Method: show_list
 * Usage: program.show_list();
 * ------------------------------------------------------------
 * show the list of the program
 */
    void show_list();
private:
